...
- **Tuning knobs**: `INK_LIFE`/`INK_DILUTE_TAU` (persistence), `INK_RISE`/`INK_SPREAD`/`INK_SIGMA0` (plume shape), curl warp 0.09/0.9 and density thresholds 0.22/0.7 in the shader (tendril character), wisp gain 0.18.

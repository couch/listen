...
- Playlist footer: created and edited dates as a bulleted list below the track list, aligned to the track grid (bullets in the number column, text under the track titles); no track count — the track list is already numbered; scroll to reveal

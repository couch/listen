import{C as p,P as h,a as d}from"./main-yAJE0TB4.js";import{h as u,i as l}from"./ids-C7ranKV5.js";const s=[8,12,18,26],i=[90,60,45,36],c=.3,f=.3,r=4;function v(t,e,a){const o=n=>Math.max(-1,Math.min(n,1));return[a*.5+o(t)*c,.5+o(e)*c]}const m=d+`

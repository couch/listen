import{C as u,P as p,a as m}from"./main-C9KtPpyw.js";import{u as _,w as l}from"./ids-C-tL2VXR.js";const f=Math.PI*2,g=48,v=18,b=.015,x=12,e=.13,S=.84,r=24,i=28,n=9,C=.016,A=.7,w=.6,O=.08,F=.04,h=4,c=o=>Math.max(-1,Math.min(1,o));function I(o){const t=o/g;return f*(t-Math.floor(t))}function T(o){const t=o/x;return t-Math.floor(t)}function D(o,t,a,s){const d=b*Math.sin(f*o/v)+c(a)*O;return[t*.5+d,S-c(s)*F]}const $=m+`

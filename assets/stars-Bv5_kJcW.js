import{C as p,P as h,a as d}from"./main-DP0h6V2S.js";import{u,w as l}from"./ids-5mOaK_zc.js";const s=[8,12,18,26],i=[90,60,45,36],c=.3,f=.3,r=4;function v(t,e,a){const o=n=>Math.max(-1,Math.min(n,1));return[a*.5+o(t)*c,.5+o(e)*c]}const m=d+`
